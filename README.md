...
[![My Skills](https://skillicons.dev/icons?i=php,laravel,java,js,nodejs,express,html,css,bootstrap,mysql,mongodb,wordpress,bash,powershell,python,django,uml)](https://skillicons.dev)
